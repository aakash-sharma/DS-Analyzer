...
for arch in 'resnet18' 'resnet50' 'vgg11'; do
		for batch in 32 48 64 80 128; do
	    echo "==============================================="
	    echo "$batch $arch"
	    echo "==============================================="
#			python3 -u harness.py --nproc_per_node=1 -j 4 -a $arch --nnodes=1 -b $batch --steps RUN1 RUN2 RUN3 --resume_dir results/results-p3/p3.2xlarge/dali-cpu/  image_classification/pytorch-imagenet-dali-mp.py 
...
for arch in 'vgg11' 'vgg13' 'vgg16' 'vgg19' 'resnet34' 'resnet18' 'resnet101' 'resnet152'; do
